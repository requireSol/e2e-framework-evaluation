    ...
    <div className="space-y-8 p-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <span
            ...
            data-testid={E2ETestIds.text_type}
          >
            {typeText || "..."}
          </span>
        </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <input
            id="blurInput"
            data-testid={E2ETestIds.input_blur}
            type="text"
            onBlur={() => setBlurText("Blur")}
            className="rounded border px-4 py-2 text-black dark:text-white"
          />
          <span
            data-testid={E2ETestIds.text_blur}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <input
            id="clearInput"
            data-testid={E2ETestIds.input_clear}
            type="text"
            value={clearText}
          ...
          />
          <span
            data-testid={E2ETestIds.text_clear}
            className="text-lg text-gray-500"
          >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <input
              id="submitInput"
              data-testid={E2ETestIds.input_submit}
              type="text"
              value={submitText}
          ...
          <span
            data-testid={E2ETestIds.button_submit}
            className="text-lg text-gray-500"
          >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <button
            id="clickButton"
            data-testid={E2ETestIds.button_click}
          ...
          <span
            data-testid={E2ETestIds.text_click}
            className="text-lg text-gray-500"
          >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            data-testid={E2ETestIds.button_doubleClick}
          ...
          <span
            data-testid={E2ETestIds.text_doubleClick}
            className="text-lg text-gray-500"
          >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <button
            id="rightClickButton"
            data-testid={E2ETestIds.button_rightClick}
          ...
          <span
            data-testid={E2ETestIds.text_rightClick}
            className="text-lg text-gray-500"
          >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <input
            id="checkInput"
            data-testid={E2ETestIds.input_check}
            type="checkbox"
            onChange={(e) =>
          ...
          />
          <span
            data-testid={E2ETestIds.text_check}
            className="text-lg text-gray-500"
          >
            {checkText || "No Status"}
          </span>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <select
            id="selectInput"
            data-testid={E2ETestIds.input_select}
          ...
          <span
            data-testid={E2ETestIds.text_select}
            className="text-lg text-gray-500"
          >
      ...
      <div
        ...
        data-testid={E2ETestIds.div_scroll}
      ...
      <div className="text-lg dark:text-white">
        ...
        <span
          data-testid={E2ETestIds.text_scroll}
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
          <input
            style={{ maxWidth: "500px" }}
            id="triggerSlider"
            data-testid={E2ETestIds.input_slider}
            type="range"
            min={0}
            max={100}
            step={1}
          ...
          />
          <span
            data-testid={E2ETestIds.text_slider}
            className="text-lg text-gray-500"
          >
            {triggerText || "0"}
          </span>
